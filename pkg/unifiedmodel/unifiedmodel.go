...
// NewUnifiedModel creates a new UnifiedModel with all maps properly initialized.
// This ensures consistent JSON serialization across all database adapters.
// Use this function instead of manually creating UnifiedModel instances to avoid
// JSON marshaling issues caused by uninitialized (nil) maps.
func NewUnifiedModel(dbType dbcapabilities.DatabaseType) *UnifiedModel {
	return &UnifiedModel{
		...
		WindowViews:          make(map[string]WindowView),
		MaterializedViews:    make(map[string]MaterializedView),
		ExternalTables:       make(map[string]ExternalTable),
		ForeignTables:        make(map[string]ForeignTable),
		...
		PropertyKeys:         make(map[string]PropertyKey),
		Indexes:              make(map[string]Index),
		Constraints:          make(map[string]Constraint),
		Sequences:            make(map[string]Sequence),
		Identities:           make(map[string]Identity),
		UUIDGenerators:       make(map[string]UUIDGenerator),
		...
		PackageBodies:        make(map[string]PackageBody),
		Macros:               make(map[string]Macro),
		Rules:                make(map[string]Rule),
		WindowFuncs:          make(map[string]WindowFunc),
		...
		TextSearchComponents: make(map[string]TextSearchComponent),
		...
		TimeTravel:           make(map[string]TimeTravel),
		Extensions:           make(map[string]Extension),
		Plugins:              make(map[string]Plugin),
		ModuleExtensions:     make(map[string]ModuleExtension),
		TTLSettings:          make(map[string]TTLSetting),
		Dimensions:           make(map[string]DimensionSpec),
		DistanceMetrics:      make(map[string]DistanceMetricSpec),
		Projections:          make(map[string]Projection),
		AnalyticsAggs:        make(map[string]AggregationOp),
		Transformations:      make(map[string]TransformationStep),
