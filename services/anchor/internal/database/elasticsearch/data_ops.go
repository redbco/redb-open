...
func (d *DataOps) Fetch(ctx context.Context, indexName string, limit int) ([]map[string]interface{}, error) {
	data, err := FetchData(d.conn.client, indexName, limit)
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.Elasticsearch, "fetch_data", err)
	}
	return data, nil
}
...
func (d *DataOps) FetchWithColumns(ctx context.Context, indexName string, columns []string, limit int) ([]map[string]interface{}, error) {
	data, err := FetchData(d.conn.client, indexName, limit)
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.Elasticsearch, "fetch_data_with_columns", err)
	}
...
func (d *DataOps) Insert(ctx context.Context, indexName string, data []map[string]interface{}) (int64, error) {
	count, err := InsertData(d.conn.client, indexName, data)
	if err != nil {
		return 0, adapter.WrapError(dbcapabilities.Elasticsearch, "insert_data", err)
	}
	return count, nil
}

func (d *DataOps) Update(ctx context.Context, indexName string, data []map[string]interface{}, whereColumns []string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.Elasticsearch, "update data", "not yet implemented")
}

func (d *DataOps) Upsert(ctx context.Context, indexName string, data []map[string]interface{}, uniqueColumns []string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.Elasticsearch, "upsert data", "not yet implemented")
}

func (d *DataOps) Delete(ctx context.Context, indexName string, conditions map[string]interface{}) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.Elasticsearch, "delete with conditions", "not yet implemented")
}

func (d *DataOps) Stream(ctx context.Context, params adapter.StreamParams) (adapter.StreamResult, error) {
	return adapter.StreamResult{}, adapter.NewUnsupportedOperationError(dbcapabilities.Elasticsearch, "stream data", "not yet implemented")
}
...
func (d *DataOps) ExecuteQuery(ctx context.Context, query string, args ...interface{}) ([]interface{}, error) {
	...
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.Elasticsearch, "execute_query", err)
	}
	return result, nil
}

func (d *DataOps) ExecuteCountQuery(ctx context.Context, query string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.Elasticsearch, "execute_count_query", "not yet implemented")
}
...
func (d *DataOps) GetRowCount(ctx context.Context, indexName string, whereClause string) (int64, bool, error) {
	...
	if err != nil {
		return 0, false, adapter.WrapError(dbcapabilities.Elasticsearch, "get_row_count", err)
	}
...
func (d *DataOps) Wipe(ctx context.Context) error {
	...
	if err != nil {
		return adapter.WrapError(dbcapabilities.Elasticsearch, "wipe_database", err)
	}
	return nil
}
