...
// DataOps implements data operations for Redshift.
type DataOps struct {
	conn *Connection
}

// Fetch retrieves rows from Redshift.
...
// Insert inserts rows into Redshift.
...
// Update updates rows in Redshift.
...
// Upsert performs upsert operation in Redshift.
...
// Delete deletes rows from Redshift.
