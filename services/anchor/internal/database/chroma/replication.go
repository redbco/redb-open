...
func CreateReplicationSource(client *ChromaClient, collectionNames []string, databaseID string, databaseName string, eventHandler func(map[string]interface{})) (common.ReplicationSourceInterface, error) {
