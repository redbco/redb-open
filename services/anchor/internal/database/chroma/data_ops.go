...
func (d *DataOps) Insert(ctx context.Context, collectionName string, data []map[string]interface{}) (int64, error) {
	...
	if err != nil {
		return 0, adapter.WrapError(dbcapabilities.Chroma, "insert_data", err)
	}
	return count, nil
}

func (d *DataOps) Update(ctx context.Context, indexName string, data []map[string]interface{}, whereColumns []string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.Chroma, "update data", "not yet implemented")
}
...
func (d *DataOps) Stream(ctx context.Context, params adapter.StreamParams) (adapter.StreamResult, error) {
	return adapter.StreamResult{}, adapter.NewUnsupportedOperationError(dbcapabilities.Chroma, "stream data", "not yet implemented")
}
...
func (d *DataOps) ExecuteQuery(ctx context.Context, query string, args ...interface{}) ([]interface{}, error) {
	...
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.Chroma, "execute_query", err)
	}
	return result, nil
}

func (d *DataOps) ExecuteCountQuery(ctx context.Context, query string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.Chroma, "execute_count_query", "not supported")
}
...
func (d *DataOps) GetRowCount(ctx context.Context, indexName string, whereClause string) (int64, bool, error) {
	...
	if err != nil {
		return 0, false, adapter.WrapError(dbcapabilities.Chroma, "get_row_count", err)
	}
...
func (d *DataOps) Wipe(ctx context.Context) error {
	...
	if err != nil {
		return adapter.WrapError(dbcapabilities.Chroma, "wipe_database", err)
	}
	return nil
}
