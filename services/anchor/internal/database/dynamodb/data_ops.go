...
func (d *DataOps) Fetch(ctx context.Context, tableName string, limit int) ([]map[string]interface{}, error) {
	...
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.DynamoDB, "fetch_data", err)
	}
	return data, nil
}
...
func (d *DataOps) FetchWithColumns(ctx context.Context, tableName string, columns []string, limit int) ([]map[string]interface{}, error) {
	data, err := FetchData(d.conn.client, tableName, limit)
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.DynamoDB, "fetch_data_with_columns", err)
	}
...
func (d *DataOps) Insert(ctx context.Context, tableName string, data []map[string]interface{}) (int64, error) {
	...
	if err != nil {
		return 0, adapter.WrapError(dbcapabilities.DynamoDB, "insert_data", err)
	}
	return count, nil
}

func (d *DataOps) Update(ctx context.Context, tableName string, data []map[string]interface{}, whereColumns []string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.DynamoDB, "update data", "not yet implemented")
}

func (d *DataOps) Upsert(ctx context.Context, tableName string, data []map[string]interface{}, uniqueColumns []string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.DynamoDB, "upsert data", "not yet implemented")
}

func (d *DataOps) Delete(ctx context.Context, tableName string, conditions map[string]interface{}) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.DynamoDB, "delete with conditions", "not yet implemented")
}

func (d *DataOps) Stream(ctx context.Context, params adapter.StreamParams) (adapter.StreamResult, error) {
	return adapter.StreamResult{}, adapter.NewUnsupportedOperationError(dbcapabilities.DynamoDB, "stream data", "not yet implemented")
}

func (d *DataOps) ExecuteQuery(ctx context.Context, query string, args ...interface{}) ([]interface{}, error) {
	return nil, adapter.NewUnsupportedOperationError(dbcapabilities.DynamoDB, "execute_query", "DynamoDB doesn't use SQL queries")
}

func (d *DataOps) ExecuteCountQuery(ctx context.Context, query string) (int64, error) {
	return 0, adapter.NewUnsupportedOperationError(dbcapabilities.DynamoDB, "execute_count_query", "DynamoDB doesn't use SQL queries")
}

func (d *DataOps) GetRowCount(ctx context.Context, tableName string, whereClause string) (int64, bool, error) {
	count, exact, err := GetTableRowCount(d.conn.client, tableName, whereClause)
	if err != nil {
		return 0, false, adapter.WrapError(dbcapabilities.DynamoDB, "get_row_count", err)
	}
...
func (d *DataOps) Wipe(ctx context.Context) error {
	...
	if err != nil {
		return adapter.WrapError(dbcapabilities.DynamoDB, "wipe_database", err)
	}
	return nil
}
