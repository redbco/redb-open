...
func (s *SchemaOps) DiscoverSchema(ctx context.Context) (*unifiedmodel.UnifiedModel, error) {
	...
	if err != nil {
		return nil, adapter.WrapError(dbcapabilities.Pinecone, "discover_schema", err)
	}
	return um, nil
}
...
func (s *SchemaOps) CreateStructure(ctx context.Context, model *unifiedmodel.UnifiedModel) error {
	...
	if err != nil {
		return adapter.WrapError(dbcapabilities.Pinecone, "create_structure", err)
	}
	return nil
}
...
func (s *SchemaOps) GetTableSchema(ctx context.Context, indexName string) (*unifiedmodel.Table, error) {
	...
	if !exists {
		return nil, adapter.NewNotFoundError(dbcapabilities.Pinecone, "index", indexName)
	}
	return &table, nil
}
